...
using SuperServer.Persistence.Database;

namespace SuperServer.Api.Controllers
{
    [Route("api/user")]
    [ApiController]
    public class UserController : ControllerBase
    {
        ...
        public IActionResult Create([FromBody] UserEntity user)
        {
            ...
            {
                return StatusCode(StatusCodes.Status400BadRequest, "Parametros no son validos");
            }
        ...
        public IActionResult Delete(int id)
        {
            if (id == 0)
            {
                return StatusCode(StatusCodes.Status400BadRequest, "Id No Valido");
            }
